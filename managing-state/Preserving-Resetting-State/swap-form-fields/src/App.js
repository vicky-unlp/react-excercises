...
// input and tick the checkbox, the text will stay in the first input 
// (which is now “Last name”). Fix it so that the input text also moves 
...
// Para solucionar el problema de que se distinguen los dos componentes solamente por
// su posición dentro del padre les asignaremos una key a cada uno.